...
///////////////////////////////////////// НАПРИМЕР РЕАЛИЗОВАЛ ИСКЛЮЧЕНИЯ ВО 2 задании, остальные выпилил задания
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class for_exeption_laba5 {	
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println("\nTask 2");
		// Список студентов
		ArrayList<Student> listStudent = new ArrayList<Student>(2); // МОЖЕТ БЫТЬ ТОЛЬКО 2 студента, но исключение почемуто пропускает
...
//		listMarksPeta.add(9);
		...
		catch(ArrayIndexOutOfBoundsException ex) // Но странно почему-то пропускает
		{
		...
		printStudentInList_vibor_pocursu(listStudent, 3); // Матвея не распечатает т.к он перевелся на next курс, распечатает Peta (ЭТО ЕСЛИ СМОТРЕТЬ НА ТЕ ДАННЫЕ КОТОРЫЕ ВВОДИЛ СРАЗУ) // Вот эти // {9, 8, 9, 10}; // {3, 2, 1, 2}; // {10, 5, 8, 9};	
	}
}
